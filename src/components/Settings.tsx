  ...
  return (
    ...
    >
      <ModalContent>
        ...
        {/* Security Options */}
        <div className="space-y-4">
          <h4 className="text-sm font-semibold text-default-700">Security Options</h4>
        ...
        {/* Appearance */}
        <div className="space-y-4">
          <h4 className="text-sm font-semibold text-default-700">Appearance</h4>
