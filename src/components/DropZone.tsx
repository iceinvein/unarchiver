...
import { extractArchives, probeArchive } from "../lib/api";
import { addToQueue, settingsAtom } from "../lib/store";
		...
		>
			...
			>
				...
				<p className="text-default-500 mb-6 max-w-md">
					Drag and drop archive files here, or use the buttons below to select
					files
				</p>
