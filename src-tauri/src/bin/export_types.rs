...
fn main() {
    ...
    unarchiver_lib::commands::ExtractOptionsDTO::export().expect("Failed to export ExtractOptionsDTO");
    ...
    unarchiver_lib::commands::PasswordRequiredEvent::export().expect("Failed to export PasswordRequiredEvent");
